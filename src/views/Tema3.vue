  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero(data-aos="fade-right")
        span 3
      h1 Construcción de tejido social
        ...
        .tarjeta.tarjeta--BGC02.p-4
          .row.justify-content-center.mb-4
            .col-lg-5.col-sm-4.col-6
              img(src='@/assets/curso/temas/tema3/img-02.svg' alt='AvatarTop')
          h4.text-center Diálogo comunitario
          p.mb-0 Promover el diálogo, el respeto y la participación activa en la vida comunitaria.
        .tarjeta.tarjeta--BGC02.p-4
          .row.justify-content-center.mb-4
            .col-lg-5.col-sm-4.col-6
              img(src='@/assets/curso/temas/tema3/img-03.svg' alt='AvatarTop')
          h4.text-center Trabajo colectivo
          p.mb-0 Fomentar el trabajo colectivo y la resolución conjunta de problemas sociales, ambientales o económicos.
        .tarjeta.tarjeta--BGC02.p-4
          .row.justify-content-center.mb-4
            .col-lg-5.col-sm-4.col-6
              img(src='@/assets/curso/temas/tema3/img-04.svg' alt='AvatarTop')
          h4.text-center Convivencia solidaria
          p.mb-0 Generar espacios de convivencia, formación y acción solidaria a través de organizaciones como la familia, la escuela, asociaciones vecinales y otros grupos comunitarios.
        .tarjeta.tarjeta--BGC02.p-4
          .row.justify-content-center.mb-4
            .col-lg-5.col-sm-4.col-6
              img(src='@/assets/curso/temas/tema3/img-05.svg' alt='AvatarTop')
          h4.text-center Valores sociales
          p.mb-0 Fortalecer valores como la solidaridad, el respeto y la equidad, y mantener normas que regulen la interacción y promuevan el bienestar común.
        .tarjeta.tarjeta--BGC02.p-4
          .row.justify-content-center.mb-4
            .col-lg-5.col-sm-4.col-6
              img(src='@/assets/curso/temas/tema3/img-06.svg' alt='AvatarTop')
          h4.text-center Transmisión cultural 
          p.mb-0 Incluir procesos de institucionalización y transmisión de valores y prácticas sociales entre generaciones.
    ...
    #t_3_1.titulo-segundo.color-acento-contenido(data-aos="fade-left")
      h2 3.1. Estrategias para fortalecer la construcción del tejido social 
